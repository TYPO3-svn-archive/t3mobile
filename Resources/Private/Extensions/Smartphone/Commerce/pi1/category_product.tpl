...
<div class="commerce-single">
	...
	<!--  Product -->
	<div class="ui-listview ui-listview-inset ui-corner-all ui-shadow ui-corner-bottom commerce-single-product">
		<h2 class="ui-li ui-li-divider ui-btn ui-bar-a ui-corner-top ui-btn-up-undefined">###PRODUCT_TITLE###</h2>
		<div class="ui-btn-up-c ui-corner-bottom news-latest-content">
			###PRODUCT_IMAGES###
			###PRODUCT_DESCRIPTION###
...
<table class="com-select-attributes" cellspacing="0" cellpadding="0" border="0">
	<tr class="com-select-row">	
		...
		<!-- ###SELECTOR_ATTRIBUTES_RADIOBUTTON_ITEM### begin-->
			...
			<input type="radio" onClick="###SELECT_ATTRIBUTES_ON_CHANGE###" name="###SELECT_ATTRIBUTES_HTML_ELEMENT_NAME###" id="###SELECT_ATTRIBUTES_HTML_ELEMENT_KEY###_###SELECT_ATTRIBUTES_VALUE_VALUE###" value="###SELECT_ATTRIBUTES_VALUE_VALUE###" ###SELECT_ATTRIBUTES_VALUE_STATUS### />
			<br />
...
<table class="com-select-attributes" cellspacing="0" cellpadding="0" border="0">
	<tr class="com-select-row">	
		...
		<option value="###SELECT_ATTRIBUTES_VALUE_VALUE###" ###SELECT_ATTRIBUTES_VALUE_STATUS###>
